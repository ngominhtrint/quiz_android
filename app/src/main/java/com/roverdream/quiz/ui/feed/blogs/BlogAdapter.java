...
import com.roverdream.quiz.databinding.ItemBlogEmptyViewBinding;
import com.roverdream.quiz.databinding.ItemBlogViewBinding;
import com.roverdream.quiz.ui.base.BaseViewHolder;
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                ItemBlogViewBinding blogViewBinding = ItemBlogViewBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
                return new BlogViewHolder(blogViewBinding);
            case VIEW_TYPE_EMPTY:
                default:
                ItemBlogEmptyViewBinding emptyViewBinding = ItemBlogEmptyViewBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
